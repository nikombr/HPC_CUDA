...
FILE_NO_REDUCTION_ASYN=$FOLDER/no_reduction_asyn/result06.txt
...
do
    ...
    mpirun -npernode 1 ./${EXECUTEFOLDER}mgpu_no_reduction_asyn $N $ITER $TOLERANCE $START_T >> $FILE_NO_REDUCTION_ASYN
